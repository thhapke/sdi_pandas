...
class test :
    ...
    ORDER_PRODUCT_MD = 4
    PORTAL1_PORTAL2 = 5
test_scenario = test.PORTAL1_PORTAL2
...
try:
    ...
    class api:
        ...
        def set_test(test_scenario):
            ...
            elif test_scenario == test.PORTAL1_PORTAL2 :
                l_df = pd.read_csv("/Users/d051079/data/OptRanking/portal1/portal1_prep1.csv",sep=';')
                r_df = pd.read_csv("/Users/d051079/data/OptRanking/portal2/portal2_provider.csv",sep=';')
            else :
                l_df = pd.DataFrame(
