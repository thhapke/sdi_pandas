...
try:
    ...
    class api:
        ...
        class config:
            ...
            version = '0.0.17'
            tags = {'pandas': '', 'sklearn': ''}
            operator_description = "linRegressionPredict"
            prediction_col_only = False
            config_params['prediction_col_only'] = {'title': 'Prediction Columns only', 'description': 'Prediction Columns only', 'type': 'boolean'}
            regresssion_cols_value = 'None'
            config_params['regresssion_cols_value'] = {'title': 'Set value for some regression columns', 'description': 'Set value for some regression columns', 'type': 'string'}
