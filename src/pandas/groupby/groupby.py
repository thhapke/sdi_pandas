...
try:
    ...
    class api:
        ...
        class config:
            ...
            version = '0.0.17'
            tags = {'pandas': ''}
            operator_description = "groupby"
            groupby = 'None'
            config_params['groupby'] = {'title': 'Groupby Columns', 'description': 'Groupby Columns', 'type': 'string'}
            aggregation = 'None'
            config_params['aggregation'] = {'title': 'Aggregation Mapping', 'description': 'Aggregation Mapping', 'type': 'string'}
            index = False
            config_params['index'] = {'title': 'Set Index', 'description': 'Set Index', 'type': 'boolean'}
            drop_columns = 'None'
            config_params['drop_columns'] = {'title': 'Drop Columns', 'description': 'Drop Columns', 'type': 'string'}
