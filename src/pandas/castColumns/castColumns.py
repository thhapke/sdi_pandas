...
try:
    ...
    class api:
        ...
        class config:
            ...
            cast = 'None'
            config_params['cast'] = {'title': 'Cast Mapping List', 'description': 'Cast Mapping List', 'type': 'string'}
            round = False
            config_params['round'] = {'title': 'Round when cast', 'description': 'Round when cast', 'type': 'boolean'}
