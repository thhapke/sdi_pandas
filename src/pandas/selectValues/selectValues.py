...
try:
    ...
    class api:
        ...
        class config:
            ...
            version = '0.0.17'
            tags = {'pandas': ''}
            operator_description = "selectValues"
            selection_num = 'None'
            config_params['selection_num'] = {'title': 'Selection in columns of numeric type', 'description': 'Selection in columns of numeric type', 'type': 'string'}
            selection_list = 'None'
            config_params['selection_list'] = {'description': 'Selection from list  in column of string type', 'type': 'string'}
